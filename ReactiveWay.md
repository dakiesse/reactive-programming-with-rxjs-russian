...
_Создай объект Observable, который будет следить за событиями клика мыши по document, затем отфильтруй только клики которые происходят в правой части экрана, затем выведи координаты в консоль только первых 10 кликов по мере их появления._
