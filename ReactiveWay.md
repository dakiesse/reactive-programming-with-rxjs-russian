...
Чтобы соответствовать нашим требованиям, мы ввели внешнее состояние с помощью глобальных переменных кликов, учитывающих клики, сделанные до сих пор. Нам также нужно проверить два разных условия и использовать вложенные условные блоки. И когда мы закончили, нам нужно привести в порядок и отменить регистрацию события, чтобы не потерять память
