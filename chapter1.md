...
Чтобы понять, как события могут быть потоками, давайте вернем к нашей микро-программе с начала этой главы. Там мы использовали щелчки мыши как бесконечную последовательность событий, генерируемых в режиме реального времени при нажатии пользователем. Эрик Мейер, изобретатель RxJS, предложил в своей статье такую мысль: «Твоя мышь - база данных».
